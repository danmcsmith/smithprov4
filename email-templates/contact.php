...
<?php 
  if(isset($_POST['email'])){
	...
	$receiver="danmcsmith@gmail.com";
	$subject="Contact from dansmith.pro";
	...
	<tr>
	<td colspan='2' align='center' valign='top'><img style=' margin-top: 15px; ' src='http://www.dansmith.pro/images/logo-email.png' ></td>
	</tr>
	<tr>
